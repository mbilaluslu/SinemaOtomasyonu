...
public class Salon6
{
	...
	final int tam=25;
			...
			public void main(String args[])
			{
				...
				JFrame Frame = new JFrame("SALON 6");
				...
				Filmler film1 = new interstellar("Interstellar", "Bilim Kurgu/ Macera", "Salon 6");
				...
				JLabel bilgi3 = new JLabel("ÖÐRENCÝ BÝLET FIYATI: " + ogr +"TL / TAM BÝLET FIYATI: " + tam +"TL");
				...
				JLabel lblNewLabel = new JLabel("ÖÐRENCÝ BILET SAYISI:");
