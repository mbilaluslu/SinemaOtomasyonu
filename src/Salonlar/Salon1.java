...
public class Salon1
{
	...
	final int tam=25;
			...
			public void main(String args[])
			{
				...
				JFrame Frame = new JFrame("SALON 1");
				...
				doktorUyku film1 = new doktorUyku("Doktor Uyku", "Gerilim/ Korku", "Salon 1");	        
				
				JPanel bilgi = new JPanel();
				bilgi.setBackground(Color.DARK_GRAY);
				bilgi.setLocation(350,20);
				bilgi.setSize(600,60);
				...
				JLabel bilgi3 = new JLabel("ÖÐRENCÝ BÝLET FÝYATI: " + ogr +"TL / TAM BÝLET FIYATI: " + tam +"TL");
				bilgi3.setBackground(Color.DARK_GRAY);
				bilgi3.setForeground(Color.YELLOW);
				bilgi3.setFont(new Font("Arial", Font.PLAIN, 20));
				bilgi3.setLocation(350,200);
				bilgi3.setSize(600,40);
				Frame.add(bilgi3);
				
				JLabel bilgi4 = new JLabel("FÝLME GÝDÝLECEK TARÝH:");
				...
				JLabel lblNewLabel_1 = new JLabel("KART ÜZERÝNDEKÝ ÝSÝM:");
				...
				JLabel lblNewLabel_3 = new JLabel("SON KULLANMA TARÝHÝ:");
				...
				JLabel lblNewLabel_4 = new JLabel("GÜVENLÝK KODU(CVV):");
				...
				JLabel lblNewLabel = new JLabel("ÖÐRENCÝ BÝLET SAYISI:");
				lblNewLabel.setForeground(Color.YELLOW);
				lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 20));
				lblNewLabel.setBounds(10,30, 278, 30);
				panel.add(lblNewLabel);
				
				JLabel lblNewLabel_11 = new JLabel("TAM BÝLET SAYISI:");
				...
				lblNewLabel_21.setForeground(Color.YELLOW);
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e)
					{
						...
						{
							JOptionPane.showMessageDialog(null,"EKSÝK KOLTUK GÝRDÝNÝZ!!");
						}
