...
public class GirisEkrani
{
	...
	public static void main(String args[])
	{
		...
		JLabel Isim = new JLabel("GAZI SINEMA SALONU");
		Isim.setForeground(Color.YELLOW);
		Isim.setFont(new Font("Broadway", Font.PLAIN, 30));
		Panel2.add(Isim);
		
		JButton Giris1 = new JButton("ÜYE GÝRÝÞÝ");
		...
		JButton Giris3 = new JButton("YÖNETÝCÝ GÝRÝÞÝ");
	...
	public static void UyeGirisi()
	{
		...
		frame = new JFrame("ÜYE GÝRÝÞ EKRANI");
		frame.setBounds(500,200,500,400);
		frame.getContentPane().setBackground(Color.DARK_GRAY);
		frame.setBackground(Color.WHITE);
		frame.getContentPane().setLayout(null);
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				try {
					while(myRs.next()){
						...
						{
							JOptionPane.showMessageDialog(null,"Giriþ Baþarýlý. Sinemamýza Hoþgeldiniz ! :)");
							SalonSecimi.SinemaSalonSecimi.main(null);
						} 
						else 
						{ 
							JOptionPane.showMessageDialog(null,"Giriþ Baþarýsýz. Lütfen tekrar deneyin veya üye olunuz.");
						}
					}
	...
	public static void YoneticiGiris()
	{
		...
		frame = new JFrame("YÖNETÝCÝ GÝRÝÞ EKRANI");
		frame.setBounds(500,200,500,400);
		frame.getContentPane().setBackground(Color.DARK_GRAY);
		frame.setBackground(Color.WHITE);
		frame.getContentPane().setLayout(null);
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				try {
					while(myRs.next()){
						...
						{ 
							JOptionPane.showMessageDialog(null,"Giriþ Baþarýsýz. Lütfen tekrar deneyin!!");
						}
					}
				} catch (SQLException e1) {
					e1.printStackTrace();
